...
class TelaDoisFatores extends StatefulWidget {
  ...
  const TelaDoisFatores({super.key, this.nomeFallback = ''});

  @override
  State<TelaDoisFatores> createState() => _TelaDoisFatoresState();
}

class _TelaDoisFatoresState extends State<TelaDoisFatores> {
  ...
  String _primeiroNome(String value) {
    ...
    if (nome.contains('@')) return nome.split('@').first;
  ...
  Widget _buildConteudo(Map<String, dynamic> dados) {
    ...
    return Column(
      children: [
        _buildCabecalho(_primeiroNome(nomeFallback)),
        Expanded(
