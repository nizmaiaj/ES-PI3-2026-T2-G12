...
Aplicativo mobile desenvolvido como parte do Projeto Integrador 3 (PI3) do curso de Engenharia de Software da PUC-Campinas (2026).
...
🔐 Autenticação de usuário (cadastro com e-mail, CPF, telefone e recuperação de senha)
🔑 Autenticação multifator (MFA/2FA) opcional
🚀 Catálogo de startups com classificação por estágio (Nova, Em operação, Em expansão)
📄 Visualização de sumário executivo, estrutura societária e capital aportado (simulado)
❓ Envio de perguntas públicas aos empreendedores
💰 Balcão de negociação para compra e venda simulada de tokens
